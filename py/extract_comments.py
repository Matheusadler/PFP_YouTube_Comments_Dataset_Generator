...
def download_comments(YOUTUBE_VIDEO_URL, language=None, sleep=0.1):
    ...
    [Retorno]        
        [generator] informações do vídeo
    """ 
...
def crawler(url):
    ...
    try: 
        ...
        return True # retorna True se os comentários foram extraidos

    except Exception as e: # se houver algum erro
        print('Error:', str(e)) # imprime o erro
        return False # retorna False se os comentários não foram extraidos
...
if __name__ == '__main__':
    ...
    for video_link in video_list: 
        crawler(video_link) # chama a função principal para cada vídeo
